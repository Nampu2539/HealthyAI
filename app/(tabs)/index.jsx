...
const ringStyles = StyleSheet.create({
  score: { color: "#fff", fontSize: 46, fontWeight: "bold", lineHeight: 50 },
  slash: { color: "rgba(255,255,255,0.6)", fontSize: 14 },
  name:  { color: "rgba(255,255,255,0.7)", fontSize: 11, marginTop: 4 },
})

// ── Metric Bar Row (result screen) ───────────────────────────────────────────
function MetricBarRow({ label, score, getColor }) {
  return (
    <View style={{ marginBottom: 14 }}>
      <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 6 }}>
        <Text style={{ color: Colors.text, fontSize: 14 }}>{label}</Text>
        <Text style={{ color: getColor(score), fontWeight: "bold" }}>
          {score.toFixed(1)}
        </Text>
      </View>
      <View style={styles.barBg}>
        <View style={[styles.barFg, { width: `${score}%`, backgroundColor: getColor(score) }]} />
      </View>
    </View>
  )
}
...
export default function Dashboard() {
  ...
  // progress: count filled numeric fields (max 4)
  ...
  if (error) return (
    <View style={styles.loadingContainer}>
      <Text style={{ color: Colors.danger, fontSize: 16, marginBottom: 16 }}>{error}</Text>
          ...
          <LinearGradient colors={[Colors.primary, Colors.primaryDark]} style={styles.header}>
            ...
            <View style={styles.badgeRow}>
              <View style={[styles.badge, {
                backgroundColor: diff >= 0 ? "rgba(74,222,128,0.2)" : "rgba(248,113,113,0.2)",
              }]}>
                  ...
                  {metrics.map((m) => {
                    ...
                    return (
                      <View key={m.key} style={styles.metricCard}>
                        ...
                        <Text style={[styles.metricVal, { color: getScoreColor(val) }]}>
                          {val.toFixed(1)}
                        </Text>
                        <View style={styles.metricBarBg}>
                          <View style={[styles.metricBarFg, {
                            width: `${val}%`, backgroundColor: getScoreColor(val),
                          }]} />
                        </View>
                      </View>
                    )
                  ...
                  <>
                      ...
                      <View style={styles.genderRow}>
                        {[
                          ...
                          <TouchableOpacity
                            ...
                            style={[
                              styles.genderBtn,
                              healthForm.gender === g.key && styles.genderBtnActive,
                            ]}
                          ...
                          >
                            ...
                            <Text style={[
                              styles.genderText,
                              healthForm.gender === g.key && { color: Colors.primary },
                            ]}>
                              {g.label}
                            </Text>
                          </TouchableOpacity>
                    ...
                    <View style={styles.card}>
                      {[
                        ...
                        <View key={f.key} style={i > 0 ? { marginTop: 16 } : {}}>
                          ...
                          <TextInput
                            style={[
                              styles.input,
                              healthForm[f.key] !== "" && styles.inputFilled,
                            ]}
                    ...
                    <View style={styles.card}>
                      ...
                      <Text style={styles.activitySelected}>
                        {activityLabels[healthForm.activity_level]}
                      </Text>
                      <View style={styles.activityRow}>
                        {[1, 2, 3, 4, 5].map((lvl) => (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.activityBtn,
                              healthForm.activity_level === lvl && styles.activityBtnActive,
                            ]}
              ...
              <View style={styles.section}>
                <View style={styles.compareCard}>
                  ...
                  <View style={[styles.diffPill, {
                    backgroundColor: diff >= 0 ? "rgba(29,158,117,0.12)" : "rgba(163,45,45,0.1)",
                  }]}>
                          ...
                          <View key={m.key} style={{ marginBottom: 16 }}>
                            <View style={{
                              ...
                              <Text style={{ color: getScoreColor(myVal), fontWeight: "bold", fontSize: 13 }}>
                                {myVal.toFixed(1)}{" "}
                                <Text style={{ color: Colors.textMuted, fontWeight: "normal" }}>
                                  / avg {avgVal}
                                </Text>
                              </Text>
                            </View>
...
const styles = StyleSheet.create({
  ...
  userPill: {
    ...
    borderRadius: 20, paddingHorizontal: 12, paddingVertical: 8, gap: 10,
  },
  pillArrow: { color: "#fff", fontWeight: "bold", fontSize: 15 },
  pillId: { color: "#fff", fontWeight: "bold", fontSize: 15, minWidth: 30, textAlign: "center" },

  // Ring
  ringWrap: { alignItems: "center", marginTop: 28, marginBottom: 4 },

  // Badges
  badgeRow: { flexDirection: "row", justifyContent: "center", gap: 10, marginTop: 22 },
  badge: {
  ...
  tabBar: {
    ...
    borderRadius: 16, padding: 3, elevation: 6,
    shadowColor: Colors.primary, shadowOpacity: 0.1, shadowRadius: 12,
    position: "relative",
  },
  tabIndicator: {
  ...
  card: {
    ...
    marginBottom: 12, elevation: 2, borderWidth: 0.5, borderColor: Colors.border,
  },
  cardTitle: { color: Colors.text, fontWeight: "bold", fontSize: 14, marginBottom: 4 },

  // Insight
  insightCard: {
    backgroundColor: Colors.accentLight, borderRadius: 16, padding: 16,
  ...
  // Info card
  infoCard: {
    backgroundColor: Colors.accentLight, borderRadius: 14, padding: 14,
    marginBottom: 12, borderLeftWidth: 4, borderLeftColor: Colors.primaryLight,
  },
  infoText: { color: Colors.text, fontSize: 13, lineHeight: 22 },

  // Field label row (with checkmark)
  fieldLabelRow: {
    flexDirection: "row", justifyContent: "space-between",
    alignItems: "center", marginBottom: 8,
  },
  fieldLabel: { color: Colors.text, fontWeight: "600", fontSize: 14 },
  fieldCheck: { color: Colors.success, fontWeight: "bold", fontSize: 14 },
  ...
  inputFilled: { borderColor: Colors.primaryLight, backgroundColor: Colors.accentLight },

  // Gender — compact equal 2-col
  genderRow: { flexDirection: "row", gap: 12, marginTop: 10 },
  genderBtn: {
  ...
  activitySelected: {
    ...
    textAlign: "center", marginBottom: 12, marginTop: 6,
  },
  ...
  // Error
  errorCard: {
    backgroundColor: "#fde8e8", borderRadius: 12, padding: 14,
    marginBottom: 12, borderWidth: 1, borderColor: "#f5c6c6",
  },
  ...
  primaryBtn: {
    ...
    padding: 18, alignItems: "center", marginBottom: 12, elevation: 4,
  },
  ...
  bmiCard: {
    backgroundColor: Colors.card, borderRadius: 16, padding: 18,
    alignItems: "center", elevation: 2, borderWidth: 0.5, borderColor: Colors.border,
  },
  ...
  compareCard: {
    ...
    marginBottom: 12, elevation: 3, alignItems: "center",
    borderWidth: 0.5, borderColor: Colors.border,
  },
  compareRow: {
    flexDirection: "row", alignItems: "center",
    justifyContent: "space-around", width: "100%", marginVertical: 16,
  },
  ...
  dualBarMark: {
    ...
    backgroundColor: Colors.textMuted, top: -3, borderRadius: 1,
  },
