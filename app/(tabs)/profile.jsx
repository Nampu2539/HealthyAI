...
const styles = StyleSheet.create({
  ...
  avatarWrap: { width: 90, height: 90, borderRadius: 45, backgroundColor: "rgba(255,255,255,0.15)", justifyContent: "center", alignItems: "center", marginBottom: 12, borderWidth: 3, borderColor: "rgba(255,255,255,0.3)" },
  name: { color: "#fff", fontSize: 22, fontWeight: "bold" },
  subtitle: { color: "rgba(255,255,255,0.65)", fontSize: 13, marginTop: 4 },
  statsRow: { flexDirection: "row", marginTop: 24, gap: 0 },
  statItem: { flex: 1, alignItems: "center", borderRightWidth: 0.5, borderRightColor: "rgba(255,255,255,0.2)" },
  statEmoji: { fontSize: 18, marginBottom: 4 },
  statValue: { color: "#fff", fontSize: 20, fontWeight: "bold" },
  statLabel: { color: "rgba(255,255,255,0.65)", fontSize: 10, marginTop: 2, textAlign: "center" },
  healthCard: { backgroundColor: Colors.card, marginHorizontal: 16, marginTop: -16, borderRadius: 20, padding: 18, elevation: 6, borderWidth: 0.5, borderColor: Colors.border, marginBottom: 8 },
  ...
  sectionTitle: { color: Colors.textMuted, fontSize: 12, fontWeight: "600", marginBottom: 8, paddingLeft: 4, textTransform: "uppercase", letterSpacing: 0.5 },
  menuCard: { backgroundColor: Colors.card, borderRadius: 16, overflow: "hidden", borderWidth: 0.5, borderColor: Colors.border, elevation: 2 },
  menuItem: { flexDirection: "row", alignItems: "center", padding: 16, gap: 12 },
  menuIconWrap: { width: 40, height: 40, borderRadius: 12, backgroundColor: Colors.accentLight, justifyContent: "center", alignItems: "center" },
  ...
  logoutBtn: { marginHorizontal: 16, marginTop: 20, backgroundColor: Colors.card, borderRadius: 16, padding: 16, alignItems: "center", borderWidth: 1, borderColor: "#f5c6c6" },
